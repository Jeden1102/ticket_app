    ...
    <div class="event__card">
        ...
        <div class="event__card__content">
            ...
            <div class="flex">
                ...
                <div v-if="event.attributes.attendants" class="event__card__content__attendants">
                    <div class="avatars">
...
export default {
    ...
    setup() {
        function getImageURL(event) {
            return `${process.env.VUE_APP_IMAGES_API}${event.attributes.Images.data[event.attributes.Main_image].attributes.url}`;
        }
