  ...
  <div class="account__container container">
    <TransitionGroup name="list">
      <div class="account__container__main">
        <h1>Profile</h1>
        <div
          class="account__container__header"
          :class="{ 'account__container__header--collapsed': !fullMenu }"
        >
        ...
        <div
          class="account__container__links"
          :class="{ 'account__container__links--collapsed': !fullMenu }"
        >
